...
export const CATEGORY_META: Record<Category, CategoryMeta> = {
  ...
  [Category.SUPERMERCADO]: { label: 'Supermercado', color: '#16a34a', bgColor: '#dcfce7', icon: 'ShoppingBasket', isIncome: false },
  [Category.RESTAURANTE]: { label: 'Restaurante / Delivery', color: '#dc2626', bgColor: '#fee2e2', icon: 'UtensilsCrossed', isIncome: false },
  [Category.ALIMENTACAO]: { label: 'Alimentação (geral)', color: '#ef4444', bgColor: '#fecaca', icon: 'ShoppingCart', isIncome: false },
  [Category.TRANSPORTE]: { label: 'Transporte', color: '#3b82f6', bgColor: '#dbeafe', icon: 'Car', isIncome: false },
  [Category.COMBUSTIVEL]: { label: 'Combustível', color: '#1d4ed8', bgColor: '#bfdbfe', icon: 'Fuel', isIncome: false },
  ...
  [Category.FARMACIA]: { label: 'Farmácia', color: '#be185d', bgColor: '#fdf2f8', icon: 'Pill', isIncome: false },
  [Category.LAZER]: { label: 'Lazer', color: '#f97316', bgColor: '#ffedd5', icon: 'Tv', isIncome: false },
  [Category.ASSINATURAS]: { label: 'Assinaturas', color: '#7c3aed', bgColor: '#ede9fe', icon: 'RefreshCw', isIncome: false },
  [Category.SERVICOS]: { label: 'Serviços', color: '#0891b2', bgColor: '#cffafe', icon: 'Wrench', isIncome: false },
