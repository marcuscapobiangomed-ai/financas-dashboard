...
export function RecentTransactions({ monthKey }: { monthKey: string }) {
  ...
  if (sorted.length === 0) {
    return (
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
        <h3 className="text-sm font-semibold text-gray-700 mb-3">Últimos Lançamentos</h3>
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      <h3 className="text-sm font-semibold text-gray-700 px-5 pt-4 pb-2">Últimos Lançamentos</h3>
            ...
            <div key={t.id} className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 group">
              ...
              <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                <button
                  ...
                  className="p-1.5 rounded text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 cursor-pointer"
                >
                  <Pencil size={12} />
                </button>
                <button
