    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
          ...
          <p className="text-sm text-gray-500 mb-5">Registre-se para comecar a usar</p>
          ...
          {success ? (
            <div className="text-sm text-emerald-700 bg-emerald-50 rounded-lg px-4 py-3">
              ...
              <Link to="/login" className="text-indigo-600 hover:text-indigo-800 font-medium mt-2 inline-block">
                Ir para Login
              </Link>
            </div>
          ) : (
