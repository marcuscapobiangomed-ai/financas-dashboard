    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Entrar</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-5">Acesse sua conta para ver seus dados</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Link to="/forgot-password" className="text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 text-center">
              Esqueci minha senha
            </Link>
          </form>
        </div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 text-center mt-4">
          Nao tem conta?{' '}
          <Link to="/register" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 font-medium">
            Criar conta
          </Link>
        </p>
      </div>
